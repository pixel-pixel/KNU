var urlSignature = (function (exports, Base64, HmacSHA1) {
	...
	var global$E = // eslint-disable-next-line es-x/no-global-this -- safe
	...
	var global$D = global$E; // eslint-disable-next-line es-x/no-object-defineproperty -- safe
	...
	var TypeError$a = global$p.TypeError; // eslint-disable-next-line es-x/no-object-defineproperty -- safe
	...
	var makeBuiltIn$2 = makeBuiltIn$3.exports = function (value, name, options) {
	  ...
	  if (options && hasOwn$8(options, 'constructor') && options.constructor) {
	    if (DESCRIPTORS$6) try {
	      defineProperty$4(value, 'prototype', {
	        writable: false
	      });
	    } catch (error) {
	      /* empty */
