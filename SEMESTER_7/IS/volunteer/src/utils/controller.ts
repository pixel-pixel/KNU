...
export type ControllerFunc = (req: Request, res: Response, next: NextFunction) => Promise<void>
...
export const del = (path: string, ...funcs: ControllerFunc[]) => handler('delete', path, ...funcs)
